module.exports = {
    ...
    NavigationManager: require('./view/NavigationManager'),
    FormItem: require('./view/FormItem'),
    GoogleSignin: require('./view/GoogleSignin'),
    NotFoundPage: require('./view/NotFoundPage'),
    PersistentRouter: require('./view/PersistentRouter'),
    ReportView: require('./view/ReportView'),
    Util: require('./view/Util')
}